...
class Categoria extends Model {
    ...
    public function save($user_id = null) {
        ...
        $this->audit('categorias', $this->id ? 'UPDATE' : 'INSERT', $this->id ?? null, $previos, ['nombre' => $this->nombre, 'descripcion' => $this->descripcion], $user_id);
        return $result;
    }
    ...
    public static function delete($id, $user_id = null) {
        ...
        $result = $db->execute();
        self::auditStatic('categorias', 'DELETE', $id, $previos, null, $user_id);
        return $result;
    }
}
